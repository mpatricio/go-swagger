...
import (
	...
	"github.com/sidewalklabs/go-swagger/examples/tutorials/todo-list/server-complete/models"
	"github.com/sidewalklabs/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations"
	"github.com/sidewalklabs/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations/todos"
)
