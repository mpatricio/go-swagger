...
import (
	...
	"github.com/sidewalklabs/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/sidewalklabs/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
