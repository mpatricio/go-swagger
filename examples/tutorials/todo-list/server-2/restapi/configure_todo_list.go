...
import (
	...
	"github.com/sidewalklabs/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/sidewalklabs/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
