...
import (
	...
	"github.com/sidewalklabs/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/sidewalklabs/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
